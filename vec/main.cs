...
class Program
{
    static void Main()
    {
        ...
        // Approximation comparison using the instance method
        bool approximationResult = v1.Approx(v2);
        Console.WriteLine("Approximation using instance method: " + approximationResult);

        // Approximation comparison using the static method
        bool approximationResultStatic = Vec.Approx(v1, v2);
        Console.WriteLine("Approximation using static method: " + approximationResultStatic);
    }
}